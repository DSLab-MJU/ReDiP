    ...
    def navigate_to_goal_recursive(self):
        ...
        if self.check_special_condition():
            ...
            if self.calc_goal_distance(self.robot_pose, self.goal_pose) > 0.45:
                ...
                self.get_logger().info(f"목적지 부근 도착으로 주행을 종료합니다. 남은 거리 : {self.calc_goal_distance(self.robot_pose, self.goal_pose)}")
...
seed = 34.0 #31 까지
test_approach = 'redip_not_astar_crowd'
