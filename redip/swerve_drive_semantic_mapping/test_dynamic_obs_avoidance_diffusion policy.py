...
class TestDynamicObsAvoidance(Node):
    ...
    def __init__(self):
        ...
        self.go_to_set_goal_timer = self.create_timer(seed, self.set_goal_and_start_navigation, callback_group=nav2_cb_group)
    ...
    def set_goal_and_start_navigation(self):
        ...
        # for crowd
        goal_pose.pose = Pose(
            position=Point(x= -20.2978439331054 , y= 10.513629913330078, z=0.0),
            orientation=Quaternion(x=0.0, y=0.0, z=0.0, w=1.0)
        )
...
seed = 34.0 #31 까지
test_approach = 'diffusion_policy_crowd'
