...
# File Names
# NAV2_LAUNCH_FILE: Final[str] = "bringup_semantic_map_test_crowd.launch.py"
NAV2_LAUNCH_FILE: Final[str] = "bringup_semantic_map_test_just_forward.launch.py"
...
def generate_launch_description() -> LaunchDescription:
    ...
    test_only_drl_node = Node(
        package='swerve_drive_semantic_mapping',
        executable='test_only_drl_node',
        name='test_only_drl_node'
    )
    ...
    ld.add_action(test_only_drl_node)
    return ld